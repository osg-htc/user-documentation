---
ospool:
  path: support_and_training/cybersecurity.md
---
...
Testing suspected vulnerabilities can place shared systems, user data, and site resources at risk. These actions may also constitute a violation of [OSG/PATh Use Policies](https://portal.osg-htc.org/documentation/overview/references/policy/).
...
[**security@osg-htc.org**](mailto:security@osg-htc.org) is the standard email address open to the OSG public for reporting of security incidents.  
