...
<br>
Yes. Fill out <a href="http://osg-htc.org/ospool-quota-increase.html">this form</a> if you think you'll need a quota increase for `/home`, or `/ospool` to accommodate a set of concurrently-running jobs. We can suppport very large amounts of data, the default quotas are just a starting point.
<br>
</details>
