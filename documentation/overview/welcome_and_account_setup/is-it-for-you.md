...
**[Full OSG User Documentation](https://support.opensciencegrid.org/support/home)** including our [Roadmap to HTC Workload Submission](../../../managing_htc_workloads_on_osg_connect/htc_workload_planning_testing_scaling_up/roadmap/-roadmap-to-htc-workload-submission-via-osg-connect)

**[OSG User Training materials](../../../support_and_training_resources/education_and_training/osgusertraining/)** . Live training sessions are advertised/open to those with active accounts on OSG Connect.
