...
- the file is less than 1GB in size (if larger, you'll need to pre-stage them for [stash-based transfer](../../../managing_htc_workloads_on_osg_connect/managing_data_for_jobs/stashcache/)
